...
def get_conf(custom_args_list=[], path_root="."):
    ...
    Args:
        custom_args: (callable or list of callables) Function or list of functions that take the parsers and first add
        the config file, next add all arguments in this config file.
    ...
    p.add_argument('--use_visdom', type=parse_bool, required=True,
                   help='Makes plot in visdom yes/no. Slows startup time.')
    p.add_argument('--start_visdom', type=parse_bool, required=True,
                   help='Automatically start visdom if not running yes/no.')
    ...
    p.add_argument('--sparse', type=SparseMethods, required=True, help="Sparsify procedure. See docs.")
    ...
    p.add_argument('--use_entropy', type=parse_bool, required=True, help="Include entropy in the loss yes/no.")
    p.add_argument('--beta', type=float, required=True, help="The scaling factor of the entropy_loss")
    p.add_argument('--compute_activation', type=parse_bool, required=True,
                        help="Compute the activation of second layer yes/no.")
