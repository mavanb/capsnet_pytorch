...
# https://github.com/AndreasMadsen/course-02456-sparsemax/blob/master/tensorflow_python/sparsemax.py
...
x = np.asarray([[(1 + (random.uniform(-1*a, a))) for i in range(10)]])

z_sparse = sparsemax(x)
z_soft = softmax(x)
print(x[:,0:6])
print(z_sparse[:,0:6])
print(z_soft[:,0:6])
