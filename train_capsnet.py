...
def main():
    ...
    def add_events(trainer, evaluator, train_loader, val_loader, vis):
        ...
        should_log = lambda trainer: (trainer.current_iteration % conf.log_interval == 0) or trainer.current_iteration == 1
        ...
        trainer.add_event_handler(Events.ITERATION_COMPLETED, vis_training_acc_handler(vis,
                                                            plot_every=conf.log_interval, transform=lambda x: x[4]))
